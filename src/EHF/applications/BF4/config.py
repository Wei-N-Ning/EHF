        ...
        self.repo = \
           [
            ...
            patternfinder.PatternFinder(
                ...
                # the 6th reference from game renderer, based on 20131001 dump
                patternExpected= "48 8B 0D B3 AE 0D 02 44 0F 28 88 90 02 00 00 44 0F 28 98 A0 02 00 00 44 0F 28 90 B0 02 00 00 44 0F 28 80 C0 02 00 00 48 8B 01",
            ...
            patternfinder.PatternFinderFollower(
                label = "ptrPlayerManager",
                baseVariableName = "ptrGameContext",
                isPointer = True,
                valueOffsets = [0x60, win32types.c_ulonglong, win32types.sizeof(win32types.c_ulonglong)]
                ),
           ]
